...
function App() {
  return (
    <div className="App">
      ...
      <Tweet2 tweet={ tweetsArray[0] }></Tweet2>
      <Tweet2 tweet={ tweetsArray[1] }></Tweet2>
      <Tweet2 tweet={ tweetsArray[2] }></Tweet2>

      <Tweet3 tweet={ tweetsArray[0] }></Tweet3>
      <Tweet3 tweet={ tweetsArray[1] }></Tweet3>
      <Tweet3 tweet={ tweetsArray[2] }></Tweet3>
    </div>
  );
}
